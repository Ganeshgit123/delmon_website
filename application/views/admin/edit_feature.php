			...
			<div class="row small-spacing">
				...
				<div class="box-content card white">
					...
					<div class="card-content">
						...
						<?php echo form_open('admin/update_feature', $attributes, $hidden);?>
						<div class="form-body">
							<div class="row">
								<input type="hidden" name="id" value="<?php echo $pf->id ?>">

								<div class="col-md-6">
									<div class="form-group">
										<label for="first_name">Name</label>
										<input class="form-control" name="name" type="text"
											value="<?php echo $pf->name ?>">
									</div>
								</div>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="hidden" name="old_image" id="old_image" value="<?php echo $pf->img ;?>">
									</div>
								</div>

								<div class="col-md-6">
									<div class="form-group">
										<?php if($pf->img !='' && $pf->img !='no file') {?>
										<img class="img-thumb" src="<?php echo base_url().'uploads/images/home/'.$pf->img;?>"
