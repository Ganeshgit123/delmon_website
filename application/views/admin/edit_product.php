			...
			<div class="row small-spacing">
				...
				<div class="box-content card white">
					<div class="box-title row">
						...
						<div class='col-md-2'>
							<a href="<?php echo base_url(); ?>admin/products"><button class="btn btn-warning">products</button></a>
						</div>
					</div>
					<div class="card-content">
						<?php $attributes = array('name' => 'edit_driver', 'id' => 'xin-form', 'autocomplete' => 'off');?>
						<?php $hidden = array('_user' => $session['user_id']);?>
						<?php echo form_open('admin/product_update', $attributes, $hidden);?>
						<div class="form-body">
							<div class="row">
								<div class="col-md-6">
							...
							<div class="row">
								...
								<div class="form-group">
                                    ...
                                    <textarea class="form-control" name="description"><?php echo $dataset->description ?></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
                                    <label for="first_name">Description (Arabic)</label>
                                    <textarea class="form-control" name="description_ar"><?php echo $dataset->description_ar ?></textarea>
									</div>
								</div>                               
							</div>								
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<img class="img-thumb" src="<?php echo base_url().'uploads/images/products/'.$dataset->image;?>"
