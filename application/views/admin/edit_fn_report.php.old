			...
			<div class="row small-spacing">
				<div class="box-content card white">
					<div class="box-title row">
						<div class='col-md-4'>
							<h4>Edit Financial Report</h4>
						</div>
						<div class='col-md-6'></div>
						<div class='col-md-2'>
                        <a href="<?php echo base_url(); ?>admin/financial_report"><button
					...
					<div class="card-content">
						...
						<?php echo form_open('admin/update_fn_report', $attributes, $hidden);?>
						<div class="form-body">
                        <div class="row">
								...
								<div class="col-md-12">
									<div class="form-group">
                                        ...
                                        <select class="form-control" name="year_id">
                                            ...
                                            <?php for ($nYear = date('Y'); $nYear >= '2004'; $nYear--) { ?>
                                                <option <?php if( $data->year_id == $nYear){echo "selected";} ?> value="<?php echo $nYear ?>"><?php echo $nYear ?></option>
                                            <?php }?>
                                        </select>
									</div>
								</div>
			...
			$.ajax({
				...
				success: function (JSON) {
					if (JSON.error != '') {
						...
						$('.save').prop('disabled', false);
						window.location.href = "<?php echo base_url();?>admin/financial_report";
					}
				},
				error: function () {
					toastr.error(JSON.error);
