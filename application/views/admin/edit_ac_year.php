			...
			<div class="row small-spacing">
				<div class="box-content card white">
					<div class="box-title row">
						...
						<div class='col-md-2'>
							<a href="<?php echo base_url(); ?>admin/academic_year"><button class="btn btn-warning">List All</button></a>
						</div>
					</div>
					<div class="card-content">
						<?php $attributes = array('name' => 'edit_driver', 'id' => 'xin-form', 'autocomplete' => 'off');?>
						<?php $hidden = array('_user' => $session['user_id']);?>
						<?php echo form_open('admin/update_ac_yea', $attributes, $hidden);?>
						<div class="form-body">
			...
			$.ajax({
				...
				success: function (JSON) {
					if (JSON.error != '') {
						...
						$('.save').prop('disabled', false);
						window.location.href = "<?php echo base_url();?>admin/academic_year";
					}
				},
				error: function () {
					toastr.error(JSON.error);
