			...
			<div class="row small-spacing">
				<div class="box-content card white">
					...
					<div class="card-content">
						...
						<?php echo form_open('admin/management_add', $attributes, $hidden);?>
						<div class="form-body">
							<div class="row">
								<div class="col-md-6">
							...
							<div class="row">
								...
								<div class="col-md-6">
                                    ...
                                    <input class="form-control"  type="text" name="designation_ar" value="">
									</div>
								</div>                               
							</div>	
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<select class="form-control" name="type" onchange=enable_subtype(this.value)>
											<option value="Board of Directors">Board of Directors</option>
											<option value="Board of Committees">Board of Committees</option>	
										</select>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										<select class="form-control" name="subtype" id="subtype">
											...
											<option value="<?php echo $type['id']?>"><?php echo ucwords($type['type']) ?></option>
											<?php } ?>
										</select>
									</div>
								</div>								
