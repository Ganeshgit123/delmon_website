			...
			<div class="row small-spacing">
				<div class="box-content card white">
					...
					<div class="card-content">
						...
						<?php echo form_open('admin/update_purpose', $attributes, $hidden);?>
						<div class="form-body">
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										<label for="first_name">Minimum content</label>
										<textarea class="form-control" type="text"
											name="min_content"><?php echo $data->min_content ?></textarea>
									</div>
								</div>
                                <div class="col-md-6">
									<div class="form-group">
										<label for="first_name">Minimum content-Arabic</label>
										<textarea class="form-control" type="text"
											name="min_content_ar"><?php echo $data->min_content_ar ?></textarea>
									</div>
								</div>
							</div>
                            <div class="row">
                                ...
                                <div class="col-md-6">
									<div class="form-group">
                                        ...
                                        <textarea class="form-control" type="text"
											name="content_ar"><?php echo $data->content_ar ?></textarea>
									</div>
								</div>
							</div>
