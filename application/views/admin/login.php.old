...
<div class="title">
	<img width="200px" height="200px" src="<?php echo base_url()?>uploads/images/<?php echo $menu->logoe?>" alt="">
</div>
<!-- /.title -->
