			...
			<div class="row small-spacing">
				<div class="box-content card white">
					<div class="box-title row">
						<div class='col-md-4'>
							<h4>Edit Management type</h4>
						</div>
						<div class='col-md-6'></div>
						<div class='col-md-2'>
                        <a href="<?php echo base_url(); ?>admin/managetype"><button
					...
					<div class="card-content">
						...
						<?php echo form_open('admin/update_managetype', $attributes, $hidden);?>
						<div class="form-body">
							<div class="row">
			...
			$.ajax({
				...
				success: function (JSON) {
					if (JSON.error != '') {
						...
						$('.save').prop('disabled', false);
						window.location.href = "<?php echo base_url();?>admin/managetype";
					}
				},
				error: function () {
					toastr.error(JSON.error);
