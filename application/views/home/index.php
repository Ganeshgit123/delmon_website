...
<body>
	...
	<section id="hero-animated" class="hero-animated d-flex align-items-center">
		<div class="container">
            ...
            ?></p>
					<a class="cta-btn align-self-start" href="<?php echo base_url()?>product" data-aos="fade-up" data-aos-delay="600"><?php if($session == 'en'){
                              echo $home->sec2_btn   ;
                            }else{
                              echo $home->sec2_btn_ar  ; 
                            }?></a>
				</div>
				<div class="col-md-1">
	...
	<section class="products">
		<div class="container">
			...
			<div class="container">
				...
				<div class="col-md-3">
				<a href="" target="_blank"><img src="assets/home_assets/img/feed-mill-logo-1.png" width="300px" height="300px"></a>
				</div>
						<div class="col-md-3">
				<a href="" target="_blank"><img src="assets/home_assets/img/Farm-Chicken-Logo.png" width="300px" height="300px"></a>
				...
				<div class="col-md-3"></div>
					...
					<div class="col-md-4">
						<?php if($i == 2) { ?>
						<p class="text-center"><a class="cta-btn" href="<?php echo base_url()?>product"><?php if($session == 'en'){
                              echo $home->sec2_btn   ;
                            }else{
                              echo $home->sec2_btn_ar  ; 
                            }?></a></p>
								...
								<div class="row">
									<div class="col-md-4">
										<p class="typewriter"><img src="<?php echo base_url()?>assets/home_assets/img/home/ico.png"
												width="20px" height="20px">100% <span class="fresh-in"><?php if($_SESSION["lang"]=='en') {
echo "fresh";}
...
echo "طازج";} ?></span></p>
									...
									<div class="col-md-4">
										<p class="typewriter2"><img src="<?php echo base_url()?>assets/home_assets/img/home/ico.png"
												width="20px" height="20px">100%&nbsp;<?php if($_SESSION["lang"]=='en') {
echo "Certified";}
 elseif ($_SESSION["lang"]=='ar') {
echo "موثوق ";} ?> </p>
									</div>
...
echo "طبيعى ";} ?></span></p>
			...
			<div class="row">
				...
				<div class="col-md-4">
					<img src="<?php echo base_url()?>uploads/images/home/<?php echo $home->sec4_img2?>" width="300px"
						height="170px" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="2000">
				</div>
			</div>
		</div>
	</section>
 ...
 <script type="text/javascript" src="https://www.juicer.io/embed/dawajen-bh-611b31f7-ace7-4715-9a36-44cbf1d047bd/embed-code.js" async defer></script>
		...
		<div class="section-header">
			...
			<div class="clients-slider swiper">
              ...
              <?php if($session == 'en'){ echo $key['content']; }else{ echo $key['content_ar']; }?></p> -->
							<a class="btn readmore stretched-link" target="_blank" href="<?php if($session == 'en'){ echo $key['content']; }else{ echo $key['content_ar']; }?>" role="button"
								 aria-controls="collapseExample"><?php if($_SESSION["lang"]=='en') {
echo "More";}
 elseif ($_SESSION["lang"]=='ar') {
echo " المزيد ";} ?></a>
							<div class="meta">
