...
<body>
	...
	<section id="product" style="background:url(<?php echo base_url()?>uploads/images/banners/<?php echo $banner->image ?>) !important;" class="d-flex align-items-center">
		<div class="container">
			<div class="row">

				<div class="section-header">
					<h2 class="text-center product-head" style="color:white;font-weight:900;"><?php 
            if($session == 'en'){
            ...
            ?> </h2>
					<p class="text-center  product-head-p" style="color:white;"><?php 
            if($session == 'en'){
			...
			<div class="col-md-3"></div>
				...
				<div class="col-md-4">
					<div class="item-manage">
						...
						<?php  $home = $this->Admin_model->get_single_data('home_page',array('id'=>1)) ;  ?>
						<a href="" class="btn-pro"> <?php if($session == 'en'){
                              echo $home->sec2_btn   ;
                            }else{
