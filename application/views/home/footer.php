...
<li class="<?php if($page=='privacy_policy'){echo 'active';}?>"><a href="<?php echo base_url();?>home/privacy_policy"><?php if($session == 'en') {
echo $menu->menu9;}
 elseif ($session == 'ar') {
echo $menu->menu9_ar;} ?></a></li>
...
elseif ($session == 'ar') {
  echo $value['name_ar'];} ?></a></li>
				...
				<div class="col-lg-2 col-md-6 footer-newsletter">
					<h4><?php if($_SESSION["lang"]=='en') {echo "Follow Us";}elseif ($_SESSION["lang"]=='ar') {
echo " تابعنا ";} ?>
 </h4>
