...
public function get_single_data($table,$condition= ''){
         if($condition){
...
public function get_module($method)
{ 
...
//get data row from table with conditions
public function get_menu_name($columnname)
{          
    $result =  $this->db->get('top_header')->row()->$columnname;
    return $result ; 
}
