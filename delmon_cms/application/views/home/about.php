...
elseif ($session == 'ar') {
  echo $value['min_content_ar'];} if(strlen($value['content']) > 0) { ?><a class="btn" data-bs-toggle="collapse" href="#collapseExample<?php echo $i;?>"
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-8">
					...
					<hr class="hr-line">
			<?php if($session == 'en') { echo $about->sec7_content1; }elseif ($session == 'ar'){echo $about->sec7_conten1_ar;} ?>
				...
				<div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                    ...
                    <?php 
                        ...
                        foreach ($annual_report as  $value) { ?>                
										<li><a href="<?php echo base_url()?>assets/home_assets/img/about/<?php echo $value['file']?>"
												target="_blank"><?php if($session == 'en') { echo $value['name']; }elseif ($session == 'ar'){ echo $value['name_ar']; }?></a></li>
                        <?php  }  ?>
									</ul>
								</div>
							</div>
							...
							<div id="flush-collapse<?php echo $i;?>" class="accordion-collapse collapse" aria-labelledby="flush-heading<?php echo $i;?>"
								...
								<div class="accordion-body">
									...
									<?php 
										...
										<li><a href="<?php echo base_url()?>assets/home_assets/img/about/<?php echo $value['file']?>" target="_blank"><?php if($session == 'en') { echo $value['name']; }elseif ($session == 'ar'){ echo $value['name_ar']; }?></a></li>
										<?php  }  ?>
									</ul>
								</div>
							</div>
