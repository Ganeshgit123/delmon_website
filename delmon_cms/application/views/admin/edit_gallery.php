			...
			<div class="row small-spacing">
				...
				<div class="box-content card white">
					...
					<div class="card-content">
						...
						<?php echo form_open('admin/gallery_update_image', $attributes, $hidden);?>
						<div class="form-body">
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										...
										<select class="form-control" name="type">
											...
											<option value="<?php echo $type['id']?>"
												<?php if($type['id'] == $dataset->type ){ echo 'selected' ; } ?>>
												<?php echo ucwords($type['type']) ?></option>
											<?php } ?>
										</select>
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<img class="img-thumb" src="<?php echo base_url().'uploads/images/gallery/'.$dataset->image;?>"
