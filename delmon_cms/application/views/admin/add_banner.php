 ...
 <div class="form-group">
                 ...
                 <div class="col-md-12">
                  <div class="form-group"> 
                   ...
                   <?php foreach ($pages as $value) { 
                     if( $value['menu'] == 'menu1'){
                     ?>
                   	<option value="<?php echo $value['menu']?>"><?php echo ucwords($value['controller']) ?></option>
                  <?php } } ?>
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group"> 
                    ...
                    <textarea class="form-control" id="banner_content_en" type="text" name="banner_content"></textarea>
                ...
                <div class="col-md-6">
                  <div class="form-group"> 
                    ...
                    <textarea class="form-control" id="banner_content_ar" type="text" name="banner_content_ar"></textarea>
